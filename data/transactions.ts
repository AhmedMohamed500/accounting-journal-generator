...
export const transactions: TransactionDefinition[] = [
 ...
 d("office-supplies-expense","office-supplies-expense","expenses","مصروف أدوات مكتبية ومطبوعات","Office supplies and printing","مصروف أدوات مكتبية ومطبوعات","Office supplies and printing","النقدية / المستحقات","Cash / Payable",["أقلام","ورق","مطبوعات","قرطاسية","office supplies"],"cash"),
 d("marketing-expense","marketing-expense","expenses","مصروف تسويق وإعلان","Marketing and advertising expense","مصروف التسويق والإعلان","Marketing expense","النقدية / المستحقات","Cash / Payable",["تسويق","إعلان","دعاية","marketing"],"cash"),
 d("professional-fees","professional-fees","expenses","أتعاب مهنية واستشارية","Professional and consulting fees","أتعاب مهنية واستشارية","Professional fees","النقدية / المستحقات","Cash / Payable",["أتعاب","استشارة","محامي","مراجع حسابات"],"cash"),
 d("general-expense","general-expense","expenses","مصروف تشغيلي عام","General operating expense","مصروفات تشغيلية أخرى","Other operating expenses","النقدية / المستحقات","Cash / Payable",["مصروف","نظافة","انتقالات","ضيافة","اشتراك"],"cash"),
