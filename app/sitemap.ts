...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return ["ar", "en"].flatMap((locale) => [
    ...
    ...detectiveCases.map((caseDefinition) => ({ url: `${base}/${locale}/detective/${caseDefinition.slug}`, lastModified: new Date() })),
