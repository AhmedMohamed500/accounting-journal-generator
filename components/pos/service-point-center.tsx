...
export function ServicePointCenter({ locale }: { locale: Locale }) {
  ...
  return <div id="pos-app-root" className="grid gap-6">
    ...
    <section className="card">
      ...
      </div>      {message && <p className="warning mt-4">{message}</p>}
    </section>
...
function ReceiptRow({label,value}:{label:string;value:string}){return <div><small className="text-daftar-muted">{label}</small><b className="mt-1 block">{value}</b></div>}
