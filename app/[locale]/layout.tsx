...
export default async function Layout({ children, params }: { children: React.ReactNode; params: Promise<{ locale: string }> }) {
  ...
  return <div dir={selected === "ar" ? "rtl" : "ltr"} lang={selected}><Header locale={selected} /><main>{children}<LatestEntryImpact locale={selected} /></main><Footer locale={selected} /></div>;
}
