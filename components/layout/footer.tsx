...
export function Footer({ locale }: { locale: Locale }) {
  ...
  if (pathname.startsWith(`/${locale}/missions`)) return <footer className="mission-footer no-print"><div className="missions-container"><span>FINORA Missions</span><p>{ar?"تدريب محاسبي معزول عن بيانات الشركة.":"Accounting training isolated from company data."}</p></div></footer>;
