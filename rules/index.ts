...
export function generateJournalEntry(input: TransactionInput): GeneratedJournalEntry {
  ...
  if (["cash-sale", "credit-sale", "revenue"].includes(input.type)) {
    ...
    const mapping: Record<string, [string, string]> = {
      "customer-collection": [payment.code, "1120"], "supplier-payment": ["2100", payment.code], "rent-expense": ["5100", input.paymentMethod === "credit" ? "2210" : payment.code], "electricity-expense": ["5110", input.paymentMethod === "credit" ? "2210" : payment.code], "maintenance-expense": ["5130", input.paymentMethod === "credit" ? "2210" : payment.code], "office-supplies-expense": ["5120", input.paymentMethod === "credit" ? "2210" : payment.code], "marketing-expense": ["5400", input.paymentMethod === "credit" ? "2210" : payment.code], "professional-fees": ["5500", input.paymentMethod === "credit" ? "2210" : payment.code], "general-expense": ["5190", input.paymentMethod === "credit" ? "2210" : payment.code],
